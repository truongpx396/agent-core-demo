...
(app/object_store.py::download_bytes), not on the ingest worker's local
...
class ExtractionFailed(Exception):
    ...
    outcome (app/ingest_worker.py reports this as a normal job failure),
...
def extract_pdf_text(data: bytes) -> str:
    ...
    separator app/chunking.py's paragraph-aware splitter already expects
    ...
    posture as app/ingestor.py's own HTML-to-text stripping."""
    try:
