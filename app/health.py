"""Real dependency checks for `GET /health/ready` (app/api.py) — distinct
...
from app import qdrant_store, queue, sql_store
...
def _check_checkpointer_postgres() -> None:
    ...
    # AsyncPostgresSaver (app/agent.py), which may not even be open on
