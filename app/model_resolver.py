"""Resolves a chat model ALIAS (`app.config.CHAT_MODEL`, e.g. `"chat"`) to
...
Naming only aliases (as `app/config.py::CHAT_MODEL` already does) is what
...
leaving it visible to *forensics* (app/meter.py's usage ledger).
"""
import logging
