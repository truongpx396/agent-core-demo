"""Tests for app/eval.py's aggregation logic — run_case's repetition
...
matching the rest of this suite's hermetic discipline — app/eval.py
...
from app.eval import CaseResult, GoldenCase, grounded_claims_ratio, run_case
