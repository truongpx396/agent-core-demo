"""Tests for app/mcp_client.py — mocks the two async boundary functions
...
rest of the suite. The real stdio round trip against app/mcp_server.py was
...
class TestLoadRemoteTools:
    ...
    def test_remote_error_result_is_surfaced_not_raised(self, monkeypatch):
        ...
        same "tool output, never a crash" contract app/graph.py's
