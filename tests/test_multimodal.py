...
44): app/graph.py's `_human_text`/`_human_has_content` (extracting the text
...
query), app/agent.py's `_build_human_content` (constructing the multimodal
...
from app.graph import _human_has_content, _human_text, route_after_validation
...
class TestAnswerAndStreamTurnBuildMultimodalContent:
    ...
    def test_astream_events_turn_sends_a_multimodal_human_message_when_images_given(
        ...
        tests/test_durable_checkpoint.py) since this test only cares
