"""Tests for app/core/scrubbing.py — pure string transformation, no I/O
except reading app.core.config's current values (monkeypatched per test)."""
from app.core import scrubbing
