"""Tests for app/ingest_worker.py's process_job — the production
...
from app import ingest_queue, ingest_worker
...
class TestProcessJob:
    ...
    def test_an_extraction_failure_publishes_an_error_and_still_acks(self, monkeypatch):
        from app.extractors import ExtractionFailed
    ...
    def test_an_ingest_refusal_publishes_an_error_and_still_acks(self, monkeypatch):
        ...
        from app.ingestor import IngestRefused
