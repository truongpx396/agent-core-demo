"""Tests for app/memory.py::delete_memories — mocks qdrant_store's
count_by_filter/delete_by_filter (same boundary tests/test_tools.py mocks
qdrant_store.upsert/hybrid_search at) so these stay hermetic."""
import pytest

from app import memory, qdrant_store
