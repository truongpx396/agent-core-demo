...
- **Fault-tolerant redelivery for the Redis Streams queue** (pattern 43): a worker dying mid-turn leaves that request permanently pending — `XCLAIM`/`XAUTOCLAIM` is the standard answer, not yet wired up.
