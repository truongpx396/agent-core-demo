...
# image's platform. No headless-browser install here — crawl4ai now runs
...
# $HOME on first use — set BEFORE the final chown, so anything written as
# root above still ends up owned by appuser.
